...
export default function MainHome({ activities }) {
  ...
  const goToGyms = () => {
    navigate("/explore-activities?category=gym", {
      state: { category: "Gym" },
    }); // Испраќаме параметар во URL
  };
  const goToBoxing = () => {
    navigate("/explore-activities?category=boxing", {
      state: { category: "Boxing" },
    }); // Испраќаме параметар во URL
  };
  const goToSportsHalls = () => {
    navigate("/explore-activities?category=sports_hall", {
      state: { category: "Sports Halls" },
    }); // Испраќаме параметар во URL
  };
    ...
    <main className="container">
          ...
          <div onClick={goToGyms} className="card">
            ...
            >
              ...
              <path
                ...
                strokeWidth="2"
              />
              <path d="M36 22.5H39" stroke="#00ddeb" strokeWidth="2" />
              <path d="M18 22.5H28" stroke="#00ddeb" strokeWidth="2" />
              <path d="M7 22.5H10" stroke="#00ddeb" strokeWidth="2" />
            </svg>
            <h2>Gyms</h2>
          </div>
      ...
      <section className="right-section">
        <div className="header_map">
          <SimpleMap activities={activities} costumStyle={{ height: "650px", width: "650px" }}  activityType="All" />
        </div>
      </section>
    </main>
  );
